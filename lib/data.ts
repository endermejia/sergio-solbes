...
export const gestionAcademica: GestionAcademica[] = academicData.gestionAcademica as GestionAcademica[];
...
export const formacionAcademica: FormacionAcademica = academicData.formacionAcademica as any;

export const acreditaciones: Acreditacion[] = academicData.acreditaciones as Acreditacion[];

export const lineasInvestigacion: LineaInvestigacion[] = academicData.lineasInvestigacion as LineaInvestigacion[];

export const participacionCongresos: ParticipacionCongreso[] = academicData.participacionCongresos as ParticipacionCongreso[];

export const estanciasInvestigacion: EstanciaInvestigacion[] = academicData.estanciasInvestigacion as EstanciaInvestigacion[];

export const cursosRecibidos: CursoRecibido[] = academicData.cursosRecibidos as CursoRecibido[];

export const meritosInvestigacion: MeritoInvestigacion[] = academicData.meritosInvestigacion as MeritoInvestigacion[];
